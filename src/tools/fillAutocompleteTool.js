 ...
 * Scrive nel campo, attende il menu dei suggerimenti e clicca l'opzione ESATTA.
 * 
 ...
 * @param {string} value - Il testo da scrivere e selezionare.
 ...
 */
async function fillAutocomplete(page, inputLocator, value, resultSelector = 'ul.dropdown-menu li a') {
    try {
        await withRetry(async () => {
            ...
            // 4. Selezione Rigorosa: Cerchiamo l'opzione che corrisponde ESATTAMENTE al testo
            ...
            for (const option of options) {
                ...
                if (await option.isVisible()) {
                    ...
                    if (text && text.trim().toUpperCase() === value.toUpperCase()) {
                        await option.click();
